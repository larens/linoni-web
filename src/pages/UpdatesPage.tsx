...
const UpdatesPage: React.FC = () => {
  return (
    <div className="pt-24 pb-24 bg-gray-50 dark:bg-gray-800 min-h-screen">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">最新功能与更新</h1>
